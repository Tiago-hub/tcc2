...
class double_pendulum:
    ...
    def dpend_dt(self,x, t):
        ...
        #print(x1,x2,x3,x4)
        dxdt = np.array([   x2,
                    (2*l2*tal1*cos(x3)**2 + 2*tal2*w1*cos(x3)**2 + 2*l2*tal1*sin(x3)**2 + 2*tal2*w1*sin(x3)**2 - 2*tal2*w1*cos(x1)*cos(x3) - 2*tal2*w1*sin(x1)*sin(x3) - b1*l2*x2**2*cos(x3)**2 - b1*l2*x2**2*sin(x3)**2 + b2*w1*x4**2*cos(x1)*cos(x3) + b2*w1*x4**2*sin(x1)*sin(x3) + l2**2*m2*w1*x4**2*cos(x1)*sin(x3)**3 - l2**2*m2*w1*x4**2*cos(x3)**3*sin(x1) - g*l1*l2*m1*cos(x3)**2*sin(x1) - g*l2*m2*w1*cos(x3)**2*sin(x1) - g*l1*l2*m1*sin(x1)*sin(x3)**2 + g*l2*m2*w1*cos(x1)*cos(x3)*sin(x3) - l2*m2*w1**2*x2**2*cos(x1)*cos(x3)**2*sin(x1) + l2*m2*w1**2*x2**2*cos(x1)**2*cos(x3)*sin(x3) + l2**2*m2*w1*x4**2*cos(x1)*cos(x3)**2*sin(x3) + l2*m2*w1**2*x2**2*cos(x1)*sin(x1)*sin(x3)**2 - l2*m2*w1**2*x2**2*cos(x3)*sin(x1)**2*sin(x3) - l2**2*m2*w1*x4**2*cos(x3)*sin(x1)*sin(x3)**2)/(l2*(l1**2*m1*cos(x1)**2*cos(x3)**2 + l1**2*m1*cos(x1)**2*sin(x3)**2 + l1**2*m1*cos(x3)**2*sin(x1)**2 + m2*w1**2*cos(x1)**2*sin(x3)**2 + m2*w1**2*cos(x3)**2*sin(x1)**2 + l1**2*m1*sin(x1)**2*sin(x3)**2 - 2*m2*w1**2*cos(x1)*cos(x3)*sin(x1)*sin(x3))),
                    x4,
                    -(b2*l1**2*m1*x4**2*cos(x1)**2 - 2*m2*tal2*w1**2*cos(x1)**2 - 2*l1**2*m1*tal2*sin(x1)**2 - 2*m2*tal2*w1**2*sin(x1)**2 - 2*l1**2*m1*tal2*cos(x1)**2 + b2*m2*w1**2*x4**2*cos(x1)**2 + b2*l1**2*m1*x4**2*sin(x1)**2 + b2*m2*w1**2*x4**2*sin(x1)**2 + 2*m2*tal2*w1**2*cos(x1)*cos(x3) + 2*m2*tal2*w1**2*sin(x1)*sin(x3) - l2*m2**2*w1**3*x2**2*cos(x3)*sin(x1)**3 + l2*m2**2*w1**3*x2**2*cos(x1)**3*sin(x3) + 2*l2*m2*tal1*w1*cos(x1)*cos(x3) + 2*l2*m2*tal1*w1*sin(x1)*sin(x3) + g*l2*m2**2*w1**2*cos(x1)**2*sin(x3) + g*l1**2*l2*m1*m2*sin(x1)**2*sin(x3) - l2*m2**2*w1**3*x2**2*cos(x1)**2*cos(x3)*sin(x1) + l2*m2**2*w1**3*x2**2*cos(x1)*sin(x1)**2*sin(x3) - g*l2*m2**2*w1**2*cos(x1)*cos(x3)*sin(x1) - b1*l2*m2*w1*x2**2*cos(x1)*cos(x3) - l2**2*m2**2*w1**2*x4**2*cos(x1)*cos(x3)**2*sin(x1) + l2**2*m2**2*w1**2*x4**2*cos(x1)**2*cos(x3)*sin(x3) + l2**2*m2**2*w1**2*x4**2*cos(x1)*sin(x1)*sin(x3)**2 - l2**2*m2**2*w1**2*x4**2*cos(x3)*sin(x1)**2*sin(x3) - b1*l2*m2*w1*x2**2*sin(x1)*sin(x3) + g*l1**2*l2*m1*m2*cos(x1)**2*sin(x3) - g*l1*l2*m1*m2*w1*sin(x1)**2*sin(x3) - l1**2*l2*m1*m2*w1*x2**2*cos(x3)*sin(x1)**3 + l1**2*l2*m1*m2*w1*x2**2*cos(x1)**3*sin(x3) - g*l1*l2*m1*m2*w1*cos(x1)*cos(x3)*sin(x1) - l1**2*l2*m1*m2*w1*x2**2*cos(x1)**2*cos(x3)*sin(x1) + l1**2*l2*m1*m2*w1*x2**2*cos(x1)*sin(x1)**2*sin(x3))/(m2*(l1**2*l2**2*m1*cos(x1)**2*cos(x3)**2 + l1**2*l2**2*m1*cos(x1)**2*sin(x3)**2 + l1**2*l2**2*m1*cos(x3)**2*sin(x1)**2 + l2**2*m2*w1**2*cos(x1)**2*sin(x3)**2 + l2**2*m2*w1**2*cos(x3)**2*sin(x1)**2 + l1**2*l2**2*m1*sin(x1)**2*sin(x3)**2 - 2*l2**2*m2*w1**2*cos(x1)*cos(x3)*sin(x1)*sin(x3))),
                    tal1,
                    tal2])
