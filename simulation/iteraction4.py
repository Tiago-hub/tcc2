...
#kp, ki, kd = 3,0,0
print(kp,ki,kd)
controller_angle_1_1 = PID(Kp=kp, Ki=ki, Kd=kd, setpoint=1, sample_time=None, output_limits=(-15,15))
#controller_angle_1_2 = PID(Kp=1, Ki=0.0, Kd=0.0, setpoint=1, sample_time=None, output_limits=(-10,10))
controller_angle_2_1 = PID(Kp=kp, Ki=ki, Kd=kd, setpoint=-1, sample_time=None, output_limits=(-10,10))
